...
async def gen_thumb(videoid: str):
    try:
        ...
        arial = ImageFont.truetype("maythushar/assets/font2.ttf", 30)
        font = ImageFont.truetype("maythushar/assets/font.ttf", 30)
        title_font = ImageFont.truetype("maythushar/assets/font3.ttf", 45)
        ...
        play_icons = Image.open("maythushar/assets/play_icons.png")
